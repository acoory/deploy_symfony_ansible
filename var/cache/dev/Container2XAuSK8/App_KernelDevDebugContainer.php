...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ApiAuthController' => 'getApiAuthControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => #[\Closure(name: 'acme_api.event.jwt_created_listener', class: 'App\\EventListener\\JWTCreatedListener')] function () {
    ...
    /**
     * Gets the private '.service_locator.xsUANXq' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_XsUANXqService()
    {
        return $this->privates['.service_locator.xsUANXq'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tyiJHthpVC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    {
        $a = ($this->privates['.service_locator.xsUANXq'] ?? $this->get_ServiceLocator_XsUANXqService());
